...
data<-tibble::tibble(
  Type=c(rep("Normal",1000),rep("Negative Skew",1000),
         rep("Positive Skew",1000), rep("Leptokurtic",1000),
         rep("Platykurtic",1000)),
  disty=c(gk::rgh(1000, 0, 1, 0, 0, c = 0.8, type = c("generalised", "tukey")),
         gk::rgh(1000, 0, 1, .99, 0, c = 0.8, type = c("generalised", "tukey")),
         gk::rgh(1000, 0, 1, -.99, 0, c = 0.8, type = c("generalised", "tukey")),
         gk::rgh(1000, 0, 1, 0, 0.1, c = 0.8, type = c("generalised", "tukey")),
         gk::rgh(1000, 0, 1, 0, -0.1, c = 0.8, type = c("generalised", "tukey"))
         )
)
...
densities<-data %>% 
  ...
  ggplot2::facet_wrap(facets = ggplot2::vars(Type),nrow = 5, scales = "free",
                      strip.position = "left") +
...
combiplot<-densities+qqs

ggplot2::ggsave("./images/densqq.png",combiplot, width = 20, height = 20, units = "cm")

ggplot2::ggsave("./images/qq.png",qqs, width = 10, height = 20, units = "cm")
...
## use package "gh" for kurtotsis and skew

## gk::rgh(1000, 0, 1, 0.4, 0, c = 0.8, type = c("generalised", "tukey"))
