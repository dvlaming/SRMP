...
We cover: - Filtering (selecting cases) + Manual filter and R code - Computing new variables + compute average of the three 11 point immigration variables using R - Creating new recoded/relabelled variables + ifelse in r - use one of the 4-point immigration variables to create 'anti' and 'pro' groups + ifelse(imsmetn\<=2, "pro", "anti") - Generating descriptives and frequencies - Boxplots - Scatterplots + also split by groups - Raincloud plots
:::
